...
class _CalendarScreenState extends State<CalendarScreen> {
  ...
  // Week view - Hiển thị chi tiết 1 tuần với selector
                    ...
                    children: [
                      ...
                      if (_selectedTasks.isNotEmpty)
                        ..._selectedTasks.map((task) {
                          final startHour = task.startHour ?? 9.0;
                          final duration = task.duration;
                          final topPosition = startHour * 60;
                          final height = duration * 60;
                              ...
                              children: [
                                ...
                                if (dayTasks.isNotEmpty)
                                  ...dayTasks.map((task) {
                                    final startHour = task.startHour ?? 9.0;
                                    final duration = task.duration;
                                    final topPosition = startHour * 80;
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: taskColor.withOpacity(0.3), width: 2),
                      boxShadow: [
                        BoxShadow(
